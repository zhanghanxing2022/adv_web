...
export class PersonalCenterComponent implements OnChanges{
  @ViewChild('Three') 
  three! : ElementRef;
  ...
  meshMap = new Map();
  worldFormControl = new FormControl('', [Validators.required, Validators.min(0), Validators.max(10)]);

  @Input()
  selected_character = "rabbit";
  selected_skin = "rabbit";
  selected_action = "Idle";
  introductions = introductionMap;
